...
const translations = {
  en: {
    ...
    timeline: {
      ...
      item1Date: "Now Open",
      item1Title: "Registration",
      item1Tag: "Registration",
      item2Date: "Prep",
      item2Title: "Preparation",
      item2List1: "Critical Thinking Workshop",
      item2List2: "Communicating Ideas Workshop",
      item2List3: "Online Technical Meeting (Gladi Resik)",
      item2Tag: "Preparation",
      item3Date: "Jakarta",
      item3Title: "Competition Day",
      item3Meta: "Grand Kemang Hotel",
      item3List1: "Round 1 — Individual Position Statement",
      item3List2: "Round 2 — Round Table Discussion",
      item3List3: "Round 3 — Team Defense",
      item3Tag: "Event Day",
      item4Date: "Post-Event",
      item4Title: "Recognition",
      item4List1: "Certificates",
      item4List2: "Performance Report",
      item4List3: "Awards &amp; Recognition",
      item4Tag: "Wrap-Up"
    },
    achievement: {
    ...
    evaluation: {
      ...
      intro1: "Great decisions begin with great reasoning — which is why every participant is assessed at each stage of the competition, individual and collaborative, using one standardized framework built to measure the quality of thinking behind every decision, not just its outcome.",
      intro2: "That framework rewards neither confidence nor memorization. What's examined is how a participant actually reasons — how a problem is framed, how evidence is weighed, and how an answer holds up once it's questioned.",
      dim1Title: "Critical Analysis",
      dim1Desc: "Identifying the real problem instead of reacting to the obvious one.",
      dim2Title: "Evidence Evaluation",
      dim2Desc: "Distinguishing facts, assumptions, opinions, and weak arguments.",
      dim3Title: "Decision Making",
      dim3Desc: "Choosing the strongest solution under uncertainty.",
      dim4Title: "Communication",
      dim4Desc: "Explaining complex reasoning clearly and logically.",
      dim5Title: "Reflection",
      dim5Desc: "Defending, reconsidering, and improving ideas when challenged.",
    ...
    competition: {
      ...
      dayGlance: {
        eyebrow: "The Day",
        headline: "Competition Day at a Glance",
        copy: "See the flow of the competition day — from arrival to the closing ceremony.",
        step1Time: "08:00",
        step1Title: "Registration",
        step2Time: "09:00",
        step2Title: "Opening Ceremony",
        step3Time: "09:15",
        step3Title: "Round 1",
        step3bTime: "11:45",
        step3bTitle: "Coffee Break",
        step4Time: "12:00",
        step4Title: "Lunch Break",
        step5Time: "13:30",
        step5Title: "Round 2",
        step5bTime: "14:15",
        step5bTitle: "Coffee Break",
        step6Time: "14:30",
        step6Title: "Round 3",
        step7Time: "16:00",
        step7Title: "Inspiration Session",
        step8Time: "16:15",
        step8Title: "Awarding Ceremony",
        step9Time: "16:40",
        step9Title: "Closing Ceremony"
      },
      experience: {
  ...
  id: {
    ...
    timeline: {
      ...
      item1Title: "Pendaftaran",
      item1Tag: "Pendaftaran",
      item2Date: "Persiapan",
      item2Title: "Persiapan",
      item2List1: "Workshop Critical Thinking",
      item2List2: "Workshop Menyampaikan Gagasan",
      item2List3: "Pertemuan Teknis Daring (Gladi Resik)",
      item2Tag: "Persiapan",
      item3Date: "Jakarta",
      item3Title: "Hari Kompetisi",
      item3Meta: "Grand Kemang Hotel",
      item3List1: "Babak 1 — Pernyataan Posisi Individu",
      item3List2: "Babak 2 — Diskusi Meja Bundar",
      item3List3: "Babak 3 — Pembelaan Tim",
      item3Tag: "Hari Acara",
      item4Date: "Pasca-Acara",
      item4Title: "Apresiasi",
      item4List1: "Sertifikat",
      item4List2: "Laporan Performa",
      item4List3: "Penghargaan &amp; Apresiasi",
      item4Tag: "Penutup"
    },
    achievement: {
    ...
    evaluation: {
      ...
      intro1: "Keputusan yang baik selalu berawal dari penalaran yang baik — karena itu setiap peserta dinilai di setiap tahap kompetisi, baik individu maupun kolaboratif, menggunakan satu kerangka terstandarisasi yang dirancang untuk mengukur kualitas cara berpikir di balik setiap keputusan, bukan hanya hasil akhirnya.",
      intro2: "Kerangka itu tidak menghargai rasa percaya diri maupun hafalan. Yang diperiksa adalah bagaimana seorang peserta benar-benar bernalar — bagaimana ia merumuskan masalah, menimbang bukti, dan mempertahankan jawabannya ketika diuji.",
      dim1Title: "Analisis Kritis",
      dim1Desc: "Mengenali masalah yang sesungguhnya, bukan sekadar bereaksi terhadap apa yang tampak di permukaan.",
      dim2Title: "Evaluasi Bukti",
      dim2Desc: "Membedakan fakta, asumsi, opini, dan argumen yang lemah.",
      dim3Title: "Pengambilan Keputusan",
      dim3Desc: "Memilih solusi terkuat di tengah ketidakpastian.",
      dim4Title: "Komunikasi",
      dim4Desc: "Menjelaskan penalaran yang kompleks secara jelas dan logis.",
      dim5Title: "Refleksi",
      dim5Desc: "Mempertahankan, mempertimbangkan ulang, dan menyempurnakan gagasan saat ditantang.",
    ...
    competition: {
      ...
      dayGlance: {
        eyebrow: "Hari Kompetisi",
        headline: "Rangkaian Acara Hari Kompetisi",
        copy: "Lihat alur hari kompetisi — mulai dari kedatangan hingga upacara penutupan.",
        step1Time: "08.00",
        step1Title: "Registrasi",
        step2Time: "09.00",
        step2Title: "Upacara Pembukaan",
        step3Time: "09.15",
        step3Title: "Babak 1",
        step3bTime: "11.45",
        step3bTitle: "Coffee Break",
        step4Time: "12.00",
        step4Title: "Istirahat Makan Siang",
        step5Time: "13.30",
        step5Title: "Babak 2",
        step5bTime: "14.15",
        step5bTitle: "Coffee Break",
        ...
        step6Title: "Babak 3",
        step7Time: "16.00",
        step7Title: "Sesi Inspirasi",
        step8Time: "16.15",
        step8Title: "Upacara Penghargaan",
        step9Time: "16.40",
        step9Title: "Penutupan"
      },
      experience: {
